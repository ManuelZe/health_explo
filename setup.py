...
setup(name='gnuhealth_explo',
    ...
    package_dir={'trytond.modules.health_explo': '.'},
    packages=[
        'trytond.modules.health_explo',
        'trytond.modules.health_explo.tests',
        'trytond.modules.health_explo.report',
        'trytond.modules.health_explo.wizard',
        ],
    package_data={
        'trytond.modules.health_explo': info.get('xml', []) \
    ...
    entry_points="""
    [trytond.modules]
    health_explo = trytond.modules.health_explo
    """,
    test_suite='tests',
